...
> 系列第三集（各自独立成片）：第一集《AI 如何自己变强？》（[../self-improving-agents-video/](../self-improving-agents-video/README.md)，通用·自我进化改什么）→ 第二集《上线之后，AI 才开始上学》（[../experience-era-agents-video/](../experience-era-agents-video/README.md)，通用·部署后经验怎么攒）→ 本集**领域深潜**：自进化最先真实落地的田野——代码（可执行反馈让进化可测量）。片尾三卡回顾。
