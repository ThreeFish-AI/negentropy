...
| 系列关系 | 第三集=**领域深潜**：前两集讲通用道理（ep1 自我进化改什么 / ep2 部署后经验怎么攒），本集看自进化最先真实落地的田野——代码（可执行反馈让进化可测量）；片尾三卡回顾，各集独立成片 |
...
3. **每 60–90 秒一个记忆点**（全部取自 paper-notes 第 4 段素材库）：
   ...
   - P6 三集拼图卡（ep1 改什么 / ep2 怎么攒 / ep3 代码领域全图）
...
| P6 | 14:00–15:20 | 收尾 | 五对象一帧回顾+可信进化绿门收束 → **系列三卡**：ep1《AI 如何自己变强？》（蓝橙·自我进化改什么）/ ep2《上线之后，AI 才开始上学》（金青紫·经验怎么攒）/ ep3 本集（绿洋红·代码领域全图）→ 开放问题：学到的进化能否迁移出代码世界（largely unexplored）→ 配套仓库 Awesome-Self-Evolving-Coding-Agents → 引用卡 arXiv:2608.03392 渐黑 | 五器官地图缩略回顾；三集拼图卡并排；星空单问号；引用卡 |
