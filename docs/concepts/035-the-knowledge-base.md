...
- **Knowledge API**：提供 Pipelines/Base CRUD（含 DELETE 级联删除）/Graph/Pipelines 入口，对齐 UI 结构。
...
> **关联运维**：见 [`wiki/ops.md` §12 单实例 Catalog 与 Wiki 发布版本管理运维](../reference/wiki/ops.md#12-单实例-catalog-与-wiki-发布版本管理运维)
...
合并算法关键步骤（详见 [`wiki/ops.md` §12.2 Phase B runbook](../reference/wiki/ops.md#122-phase-b-merge-runbook)）：
