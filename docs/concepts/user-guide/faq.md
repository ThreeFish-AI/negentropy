...
检查以下几点：
1. 确认后端服务已启动（`http://localhost:3292`）
...
| `AGUI_BASE_URL`             | ADK 后端地址（前端服务端变量）                | `http://localhost:3292` |
...
| 文档                                           | 路径                                           | 说明                               |
| :--------------------------------------------- | :--------------------------------------------- | :--------------------------------- |
| **用户手册**（本文档）                         | [docs/README.md](../../README.md)      | 面向最终用户的使用指南             |
| [开发指南](../operations/development.md)                  | `docs/concepts/operations/development.md`                 | 环境搭建、开发工作流、数据库迁移   |
| [架构设计](../framework.md)                    | `docs/concepts/framework.md`                   | 一核五翼架构、流水线编排、设计模式 |
| [知识系统](../subsystems/035-the-knowledge-base.md)       | `docs/concepts/subsystems/035-the-knowledge-base.md`      | 知识管理模块的详细设计             |
| [记忆系统](../subsystems/025-the-memory-system.md)        | `docs/concepts/subsystems/025-the-memory-system.md`       | 记忆生命周期与治理机制             |
| [知识图谱](../subsystems/036-the-knowledge-graph.md)      | `docs/concepts/subsystems/036-the-knowledge-graph.md`     | 图建模与查询实现                   |
...
| [工程变更日志](../operations/engineering-changelog.md)    | `docs/concepts/operations/engineering-changelog.md`       | 里程碑与基线变更记录               |
