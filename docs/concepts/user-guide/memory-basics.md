...
> 本文聚焦"概念入门 + UI 导航"。深入设计原理见 [`025-the-memory-system.md`](../../reference/cognizes/engine/025-the-memory-system.md)；理论支撑见 [`026-memory-whitepaper.md`](../../reference/cognizes/engine/026-memory-whitepaper.md)；API 集成见 [`memory-integration.md`](./memory-integration.md)。
...
Phase 5 引入 4 个高级特性，**全部默认关闭**，按需通过环境变量或配置文件灰度启用。详细工程契约见 [`025-the-memory-system.md`](../../reference/cognizes/engine/025-the-memory-system.md) §10 与 [`026-memory-whitepaper.md`](../../reference/cognizes/engine/026-memory-whitepaper.md) §4。
...
- 架构师 → [`025-the-memory-system.md`](../../reference/cognizes/engine/025-the-memory-system.md) + [`026-memory-whitepaper.md`](../../reference/cognizes/engine/026-memory-whitepaper.md)
