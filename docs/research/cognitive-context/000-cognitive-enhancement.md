...
LlamaIndex 提供 Router Query Engine 实现自适应检索，通过 `QueryEngineTool` 定义多检索工具（向量、图谱、摘要），由 `RouterQueryEngine` 配合 `LLMSingleSelector` 自动选择最佳策略。完整实现详见 [Agent 运行时框架调研](../agent-runtime/020-agent-runtime-frameworks.md)。
...
> 完整 API、搜索模式与高级配置详见 [Cognee 深度调研](../knowledge-graph/040-cognee.md)
...
> 完整代码示例与高级配置详见 [Agent 运行时框架调研](../agent-runtime/020-agent-runtime-frameworks.md)
...
> Neo4j AI 特性与框架集成详见 [Neo4j 深度调研](../knowledge-graph/050-neo4j.md)
...
**本项目建议**：实际选用 **PostgreSQL AGE**（与 pgvector 共享基础设施）；Neo4j 详调见 [050-neo4j.md](../knowledge-graph/050-neo4j.md)，对比决策见 [051-postgres-neo4j.md](../knowledge-graph/051-postgres-neo4j.md)。

### 4.2 向量数据库

> OceanBase 多模向量检索完整调研详见 [OceanBase 三位一体调研](../retrieval-storage/033-oceanbase.md)
...
> 向量算法详见 [030](../retrieval-storage/030-vector-search-algorithm.md)、选型详见 [031](../retrieval-storage/031-vector-databases-selection.md)、深度调研详见 [032](../retrieval-storage/032-vector-databases.md)
...
> Cognee 不作为依赖引入，项目自研记忆引擎，详见 [040-cognee.md](../knowledge-graph/040-cognee.md)
...
> Cognee 快速入门与高级配置详见 [Cognee 深度调研](../knowledge-graph/040-cognee.md)；Neo4j + LlamaIndex 集成详见 [Neo4j 深度调研](../knowledge-graph/050-neo4j.md)；OceanBase 向量检索示例详见 [OceanBase 三位一体调研](../retrieval-storage/033-oceanbase.md)。
