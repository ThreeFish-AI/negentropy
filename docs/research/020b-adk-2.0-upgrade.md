...
timeline
    ...
    2025-04 : 0.1.0 初始发布
    2025-05 : 1.0.0 首个稳定版
    2025-12 : 1.23.0 Negentropy 首次接入
    2026-03 : 1.28.0 安全修复 (GHSA-rg7c-g689-fr3x)
...
**对 Negentropy 的影响**：**低**
- 工具层发现 3 处 `except Exception:`（`perception.py`、`paper.py`、`hybrid_planner.py`）
- 均为配置降级或外部 API 容错，不涉及 HITL 场景
- 当前无 HITL 需求，暂不影响
