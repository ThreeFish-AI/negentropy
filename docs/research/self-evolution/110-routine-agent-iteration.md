---
sidebar_position: 1
title: "Routine：长周期自主任务的 Agent 迭代模式调研"
---
...
下表将前述每一项模式/证据收敛为 Routine 的具体设计决策，构成"理论—实现"的可追溯映射。系统的完整架构详见 [Routine 系统架构设计](../../concepts/subsystems/039-the-routine-system.md)。
