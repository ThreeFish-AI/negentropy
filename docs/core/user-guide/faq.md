...
| [知识系统](../../concepts/035-the-knowledge-base.md)            | `docs/reference/cognizes/engine/035-the-knowledge-base.md`              | 知识管理模块的详细设计             |
| [记忆系统](../../concepts/025-the-memory-system.md)             | `docs/reference/cognizes/engine/025-the-memory-system.md`               | 记忆生命周期与治理机制             |
| [知识图谱](../../concepts/036-the-knowledge-graph.md)           | `docs/reference/cognizes/engine/036-the-knowledge-graph.md`             | 图建模与查询实现                   |
