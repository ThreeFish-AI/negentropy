...
| [SSO 集成](../../infrastructure/design/sso.md)                       | `docs/infrastructure/design/sso.md`                         | Google OAuth 认证配置              |
| [QA 流水线](../../infrastructure/design/qa-delivery-pipeline.md)     | `docs/infrastructure/design/qa-delivery-pipeline.md`        | 质量门禁与发布流程                 |
