...
>
> **相关文档**: [架构设计](../architecture/framework.md) | [知识库设计](../knowledge/design/knowledges.md)
...
> **架构依据**：[`knowledges.md` §15 单实例 Catalog 收敛（Phase 4）](../knowledge/design/knowledges.md#15-单实例-catalog-收敛phase-4在-nm-之上叠加聚合根不变量)
