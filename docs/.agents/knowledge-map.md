...
- [Framework（系统框架）](../concepts/framework.md) — 架构设计的权威参考：三层架构视图（§2.1，正文为高清静图）、应用边界与技术栈（§2.2）、一核五翼编排、三条标准流水线、启动引导、可观测性、DB schema 分域、测试金字塔与 CI/CD，10 张图正交覆盖各维度；各图的文本源集中于 [Mermaid 文本源索引](../assets/mermaid/README.md)
