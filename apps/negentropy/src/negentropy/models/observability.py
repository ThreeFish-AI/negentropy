...
class Trace(Base, UUIDMixin):
    ...
    events: Mapped[list[dict[str, Any]] | None] = mapped_column(JSONB, server_default="'[]'")
    ...
    status_code: Mapped[str | None] = mapped_column(String(10), default="UNSET", server_default="'UNSET'")
