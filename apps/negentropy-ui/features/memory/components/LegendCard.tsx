...
export function LegendCard() {
  return (
    <SidebarCard title="Legend">
      {/* Retention scores */}
      <p className="mt-3 text-micro font-semibold uppercase tracking-widest text-muted-foreground">
        Retention
      </p>
      <div className="mt-1.5 space-y-1.5 text-caption text-muted-foreground">
      ...
      <div className="mt-1.5 space-y-1 text-caption text-muted-foreground">
        <div className="flex items-center gap-2">
