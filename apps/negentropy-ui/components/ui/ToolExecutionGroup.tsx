  ...
  return (
    ...
    >
      ...
      >
        ...
        <span className="shrink-0 text-micro uppercase tracking-[0.18em] text-zinc-400">
          {expanded ? "收起" : "展开"}
        </span>
      </button>
      ...
      {expanded ? (
        <div className="mt-3 space-y-3 border-t border-zinc-200/70 pt-3 dark:border-zinc-800">
          <div className="space-y-1">
            <div className="text-micro font-semibold uppercase tracking-[0.18em] text-zinc-500 dark:text-zinc-400">
              Parameters
            </div>
    ...
    >
      ...
      >
        <div className="min-w-0">
          <div className="flex items-center gap-2">
            <span className="rounded-full bg-zinc-900 px-2 py-0.5 text-micro font-semibold uppercase tracking-[0.18em] text-zinc-50 dark:bg-zinc-100 dark:text-zinc-950">
            ...
            {block.status === "error" ? (
              <span className="rounded-full bg-red-100 px-2 py-0.5 text-micro font-semibold uppercase tracking-[0.16em] text-red-700 dark:bg-red-950/70 dark:text-red-200">
                Error
              </span>
            ) : null}
          </div>
