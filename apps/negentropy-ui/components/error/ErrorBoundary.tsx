...
function DefaultErrorFallback({
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-background p-4">
      <div className="max-w-md w-full bg-card rounded-xl shadow-lg p-6 border border-red-200">
        <div className="flex items-center gap-3 mb-4">
          ...
          <h2 className="text-lg font-semibold text-foreground">遇到错误</h2>
        </div>
        ...
        <div className="flex gap-2">
          ...
          <button onClick={() => window.location.reload()} className="flex-1 px-4 py-2 bg-muted text-foreground rounded-lg text-sm font-medium hover:bg-border transition-colors">
            刷新页面
          </button>
        </div>
      </div>
