...
| 项 | 状态 |
|---|---|
| 逐字稿 | ✅ 139 句 / 3882 字 / 7 幕 |
| 分镜 | ✅ 27 镜，覆盖性 FAIL 0 |
| 信源取证 | ✅ 6 条双轨（s13/s14）@ `67a9126c`，verify FAIL 0；字节归档 |
| 场景实现 | ✅ 7 幕 27 镜 2918 行，tsc 零错；`--check-scenes` FAIL 0 · WARN 0 |
| 配音 | ✅ 139/139 句 `sunny-steady` + `me-bright.wav` |
...
P=$I/episodes/claude-code-concurrency-video
