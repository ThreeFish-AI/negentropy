...
| 草渲 + 抽帧 QA | ✅ 25642 帧 / 6.0 分钟；7 幕 FAIL 0（WARN 2 均为刻意设计：p0-02/03 画面凝住、p6-06/07 信源卡停留） |
| **终渲交付** | ✅ `out/final.mp4` **14:14.73** · 1920×1080 @30fps · h264 yuv420p 196kb/s · aac 189kb/s · 42.1 MB（渲染 8.2 分钟）<br>终渲全分辨率抽帧 **FAIL 0 · WARN 1**（仅 p0 画面凝住）；尾幕末 6 句 **FAIL 0 · WARN 0** |
