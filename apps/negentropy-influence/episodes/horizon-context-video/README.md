...
**交付状态**：v6.1 终渲待审（2026-09-21 修复 47s 处 p0-10 句尾「Context」重复尾音——TTS 采样缺陷单句重配，视觉零改动；v6=图例 2× 扩产 + 全屏独占切换 + 阈门六维加固，口播零改动）。

**15:11.27 = 27338 帧 @30fps · 1920×1080**（v6.1 重配 p0-10 后总长 -11 帧，见 ISSUE-192；音频其余 186 句复用 v4）。
