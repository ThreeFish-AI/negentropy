...
| 5 | [《协作层：从一个到一群》](./episodes/claude-code-multiagent-video/README.md) | 多 Agent 协作：谁持有计划 | 赭金 `peer` | s12 · s15–s20 @ `67a9126c`（MIT） | **Harness Engineering 改造中**（133 句基线；改造草渲后交付） |
