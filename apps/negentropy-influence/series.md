...
| 2   | [《自己动手，给 AI 搭一个上下文层》](./episodes/context-layer-video/README.md)    | Context Layer：蓝图怎么复刻    | 工程蓝/苔绿/暖橙              | 013 蓝图重铸版 + 011 + lab/mcp 原型 @ `6f643c21`，2026-09-23                              | **v3 重制待审**（15:21 · 章节进度条首装 · 12 图 70 章回放）   |
...
| 2   | [《让判断变便宜：Jev 决策模型拆解》](./episodes/jev-decision-model-video/README.md) | Jev 决策模型：小判断怎么变便宜 | 琥珀金/青绿/兰紫/矢车菊蓝 | 200 精读 + 最小原型 @ `5ed96405` + TypeSafe 官方/adapter `e1d4cc9`/kev `b8aa777`/laya `76361c8`，2026-09-24 | **v1 终渲待审**（14:40 · archify 13 图 35 章 · 归档 ~/Documents/video） |
