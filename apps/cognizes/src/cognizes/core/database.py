...
class DatabaseManager:
    ...
    def sessions(self) -> "SessionRepository":
        if "sessions" not in self._repos:
            ...
            self._repos["sessions"] = SessionRepository(self)
    ...
    def events(self) -> "EventRepository":
        if "events" not in self._repos:
            ...
            self._repos["events"] = EventRepository(self)
    ...
    def states(self) -> "StateRepository":
        if "states" not in self._repos:
            ...
            self._repos["states"] = StateRepository(self)
    ...
    def memories(self) -> "MemoryRepository":
        if "memories" not in self._repos:
            ...
            self._repos["memories"] = MemoryRepository(self)
    ...
    def facts(self) -> "FactsRepository":
        if "facts" not in self._repos:
            ...
            self._repos["facts"] = FactsRepository(self)
    ...
    def instructions(self) -> "InstructionsRepository":
        if "instructions" not in self._repos:
            ...
            self._repos["instructions"] = InstructionsRepository(self)
        return self._repos["instructions"]
